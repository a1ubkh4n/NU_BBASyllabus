...
public class acc_acc_theory extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_acc_theory);

        webAb = (WebView) findViewById(R.id.webacc_acc_theory);
        ...
        String myurl = "file:///android_asset/www/acc_acc_theory.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_acc_theory );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_acc_theory);

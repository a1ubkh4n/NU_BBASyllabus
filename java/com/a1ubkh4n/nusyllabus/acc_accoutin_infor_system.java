...
public class acc_accoutin_infor_system extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_accoutin_infor_system);

        webAb = (WebView) findViewById(R.id.webacc_informa);
        bar=(ProgressBar) findViewById(R.id.progressacc_informa);
        ...
        String myurl = "file:///android_asset/www/acc_accoutin_infor_system.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_informa );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_informa );

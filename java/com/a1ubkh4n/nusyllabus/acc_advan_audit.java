...
public class acc_advan_audit extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_advan_audit);

        webAb = (WebView) findViewById(R.id.webacc_advan_audit);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_advan_audit);
        ...
        String myurl = "file:///android_asset/www/acc_advan_audit.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_advan_audit );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_advan_audit);

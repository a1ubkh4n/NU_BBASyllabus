...
public class acc_corporate_law extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_corporate_law);

        webAb = (WebView) findViewById(R.id.webacc_corporate_law);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_corporate_law);
        ...
        String myurl = "file:///android_asset/www/acc_corporate_law.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_corporate_law );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_corporate_law);

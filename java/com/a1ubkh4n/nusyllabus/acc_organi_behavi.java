...
public class acc_organi_behavi extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_organi_behavi);

        webAb = (WebView) findViewById(R.id.webacc_organi_behavi);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_organi_behavi);
        ...
        String myurl = "file:///android_asset/www/acc_organi_behavi.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_organi_behavi );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_organi_behavi);

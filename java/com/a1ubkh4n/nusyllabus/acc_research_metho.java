...
public class acc_research_metho extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_research_metho);

        webAb = (WebView) findViewById(R.id.webacc_research_metho);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_research_metho);
        ...
        String myurl = "file:///android_asset/www/acc_research_metho.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_research_metho );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_research_metho);

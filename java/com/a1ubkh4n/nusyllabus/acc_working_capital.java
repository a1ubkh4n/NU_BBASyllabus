...
public class acc_working_capital extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acc_working_capital);

        webAb = (WebView) findViewById(R.id.webacc_working_capital);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_working_capital);
        ...
        String myurl = "file:///android_asset/www/acc_working_capital.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.acc_working_capital );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewacc_working_capital);

...
public class addvan_accoun extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addvan_accoun);
        ...
        String myurl = "file:///android_asset/www/addvan_accoun.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.add_acc );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewaddacc);

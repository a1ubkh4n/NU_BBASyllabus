...
public class agricul_marke extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agricul_marke);

        webA = (WebView) findViewById(R.id.webagriMar);
        bar=(ProgressBar) findViewById(R.id.progressagriMar);
        ...
        String myurl = "file:///android_asset/www/agricul_marke.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.agriMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewagriMar);

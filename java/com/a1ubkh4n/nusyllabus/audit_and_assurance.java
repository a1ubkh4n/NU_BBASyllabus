...
public class audit_and_assurance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_audit_and_assurance);

        webAb = (WebView) findViewById(R.id.webaudit);
        bar=(ProgressBar) findViewById(R.id.progressBaraudit);
        ...
        String myurl = "file:///android_asset/www/audit_and_assurance.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.audi_assu );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewadu_assu);

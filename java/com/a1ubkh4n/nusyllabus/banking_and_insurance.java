...
public class banking_and_insurance extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banking_and_insurance);

        webAb = (WebView) findViewById(R.id.webbanninsu);
        bar=(ProgressBar) findViewById(R.id.progressbanninsu);
        ...
        String myurl = "file:///android_asset/www/banking_and_insurance.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.ban_insu );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewban_insu);

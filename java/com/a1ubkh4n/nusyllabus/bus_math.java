...
public class bus_math extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_math);

        webA = (WebView) findViewById(R.id.webbusmath);
        bar=(ProgressBar) findViewById(R.id.progressBusmath);
        ...
        String myurl = "file:///android_asset/www/bus_math.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.bus_math );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusmath);

...
public class bus_math_fin_Acc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_math_fin__acc);

        webA = (WebView) findViewById(R.id.webbusMathFin);
        bar=(ProgressBar) findViewById(R.id.progressbusMathFin);
        ...
        String myurl = "file:///android_asset/www/bus_math_fin_Acc.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.busMathFin );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusMathFin);

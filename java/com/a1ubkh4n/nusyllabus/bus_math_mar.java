...
public class bus_math_mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_math_mar);

        webA = (WebView) findViewById(R.id.webbusMathMar);
        bar=(ProgressBar) findViewById(R.id.progressbusMathMar);
        ...
        String myurl = "file:///android_asset/www/bus_math_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.busMathMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusMathMar);

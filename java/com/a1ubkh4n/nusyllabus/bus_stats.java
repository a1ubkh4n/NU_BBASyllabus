...
public class bus_stats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_stats);

        webA = (WebView) findViewById(R.id.webBusstat);
        bar=(ProgressBar) findViewById(R.id.progressBusstat);
        ...
        String myurl = "file:///android_asset/www/bus_stats.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.bus_stats );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbus_stats);

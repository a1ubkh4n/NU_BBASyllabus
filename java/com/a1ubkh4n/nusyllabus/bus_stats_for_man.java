...
public class bus_stats_for_man extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_stats_for_man);

        webA = (WebView) findViewById(R.id.webbusstatMan);
        bar=(ProgressBar) findViewById(R.id.progressbusstatMan);
        ...
        String myurl = "file:///android_asset/www/bus_stats_for_man.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.busstatMan);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusstatMan);

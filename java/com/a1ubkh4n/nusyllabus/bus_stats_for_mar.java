...
public class bus_stats_for_mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_stats_for_mar);

        webA = (WebView) findViewById(R.id.webbusstatMar);
        bar=(ProgressBar) findViewById(R.id.progressbusstatMar);
        ...
        String myurl = "file:///android_asset/www/bus_stats_for_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.busstatMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusstatMar);

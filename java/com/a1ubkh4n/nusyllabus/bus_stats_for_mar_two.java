...
public class bus_stats_for_mar_two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_stats_for_mar_two);

        webA = (WebView) findViewById(R.id.webbusstattwo);
        bar=(ProgressBar) findViewById(R.id.progressbusstattwo);
        ...
        String myurl = "file:///android_asset/www/bus_stats_for_mar_two.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.busstattwo);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusstattwo);

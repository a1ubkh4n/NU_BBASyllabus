...
public class business_and_commer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_and_commer);

        webA = (WebView) findViewById(R.id.webBusndCommer);
        bar=(ProgressBar) findViewById(R.id.progressBusndCommer);
        ...
        String myurl = "file:///android_asset/www/business_and_commer.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.buss_comm );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbus_com);

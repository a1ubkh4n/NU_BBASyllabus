...
public class business_commu extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_commu);

        webA = (WebView) findViewById(R.id.webBusCommu);
        bar=(ProgressBar) findViewById(R.id.progressBusCommu);
        ...
        String myurl = "file:///android_asset/www/business_commu.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.bus_com );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbuscom);

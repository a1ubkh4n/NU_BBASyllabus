...
public class business_commu_for_finAcc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_commu_for_fin_acc);

        webA = (WebView) findViewById(R.id.webbusCommuFin);
        bar=(ProgressBar) findViewById(R.id.progressbusCommuFin);
        ...
        String myurl = "file:///android_asset/www/business_commu_for_finAcc.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.busCommuFin );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbusCommuFin);

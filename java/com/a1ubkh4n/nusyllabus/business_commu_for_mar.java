...
public class business_commu_for_mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_commu_for_mar);

        webA = (WebView) findViewById(R.id.webbuscomMar);
        bar=(ProgressBar) findViewById(R.id.progressbuscomMar);
        ...
        String myurl = "file:///android_asset/www/business_commu_for_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.buscomMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbuscomMar);

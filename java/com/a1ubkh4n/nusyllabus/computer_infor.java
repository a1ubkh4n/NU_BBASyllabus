...
public class computer_infor extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_infor);

        webA = (WebView) findViewById(R.id.webCom);
        bar=(ProgressBar) findViewById(R.id.progressCom);
        ...
        String myurl = "file:///android_asset/www/computer_infor.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.com_info );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewcominfo);

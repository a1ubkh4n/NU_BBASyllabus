...
public class computer_infor_fin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_infor_fin);

        webA = (WebView) findViewById(R.id.webcomInfoFin);
        bar=(ProgressBar) findViewById(R.id.progresscomInfoFin);
        ...
        String myurl = "file:///android_asset/www/computer_infor_fin.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.comInfoFin );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewcomInfoFin);

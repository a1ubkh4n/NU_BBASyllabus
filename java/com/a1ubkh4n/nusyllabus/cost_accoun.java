...
public class cost_accoun extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cost_accoun);

        webA = (WebView) findViewById(R.id.webCost);
        bar=(ProgressBar) findViewById(R.id.progressCost);
        ...
        String myurl = "file:///android_asset/www/cost_accoun.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.costAcc);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewCostAcc);

...
public class enternship extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enternship);

        webA = (WebView) findViewById(R.id.webEntern);
        bar=(ProgressBar) findViewById(R.id.progressEntern);
        ...
        String myurl = "file:///android_asset/www/enternship.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.enterns);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewEntern);

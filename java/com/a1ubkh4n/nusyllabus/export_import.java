...
public class export_import extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webA = (WebView) findViewById(R.id.webExport);
        bar=(ProgressBar) findViewById(R.id.progressExport);
        ...
        String myurl = "file:///android_asset/www/mar_consumer_behaviou.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.expo_impor );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewexport);

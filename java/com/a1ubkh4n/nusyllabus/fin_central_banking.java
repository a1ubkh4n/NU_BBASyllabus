...
public class fin_central_banking extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_central_banking);

        webAb = (WebView) findViewById(R.id.webfin_central_banking);
        bar=(ProgressBar) findViewById(R.id.progressBarfin_central_banking);
        ...
        String myurl = "file:///android_asset/www/fin_central_banking.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_central_banking);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_central_banking);

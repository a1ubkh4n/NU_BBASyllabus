...
public class fin_comparative_financi extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_comparative_financi);

        webAb = (WebView) findViewById(R.id.webfin_comparative_financi);
        bar=(ProgressBar) findViewById(R.id.progressBaracc_acc_theory);
        ...
        String myurl = "file:///android_asset/www/fin_comparative_financi.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_comparative_financi );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_comparative_financi);

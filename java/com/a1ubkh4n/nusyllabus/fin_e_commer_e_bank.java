...
public class fin_e_commer_e_bank extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_e_commer_e_bank);

        webAb = (WebView) findViewById(R.id.webfin_e_commer_e_bank);
        bar=(ProgressBar) findViewById(R.id.progressBarfin_e_commer_e_bank);
        ...
        String myurl = "file:///android_asset/www/fin_e_commer_e_bank.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_e_commer_e_bank);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_e_commer_e_bank);

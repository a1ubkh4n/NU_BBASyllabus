...
public class fin_finance_market extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_finance_market);

        webAb = (WebView) findViewById(R.id.webfinanMar);
        bar=(ProgressBar) findViewById(R.id.progressfinanMar);
        ...
        String myurl = "file:///android_asset/www/fin_finance_market.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.finanMar);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfinanMar);

...
public class fin_human_resour_manag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_human_resour_manag);

        webAb = (WebView) findViewById(R.id.webfin_human_resour_manag);
        bar=(ProgressBar) findViewById(R.id.progressBarfin_human_resour_manag);
        ...
        String myurl = "file:///android_asset/www/fin_human_resour_manag.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_human_resour_manag);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_human_resour_manag);

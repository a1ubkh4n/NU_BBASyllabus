...
public class fin_public_finan_tax extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_public_finan_tax);

        webAb = (WebView) findViewById(R.id.webfin_public_finan_tax);
        bar=(ProgressBar) findViewById(R.id.progressBarfin_public_finan_tax);
        ...
        String myurl = "file:///android_asset/www/fin_public_finan_tax.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_public_finan_tax );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_public_finan_tax);

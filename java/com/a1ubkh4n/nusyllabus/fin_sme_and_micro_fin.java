...
public class fin_sme_and_micro_fin extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_sme_and_micro_fin);

        webAb = (WebView) findViewById(R.id.webfin_sme_and_micro_fin);
        bar=(ProgressBar) findViewById(R.id.progressBarfin_sme_and_micro_fin);
        ...
        String myurl = "file:///android_asset/www/fin_sme_and_micro_fin.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_sme_and_micro_fin );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfin_sme_and_micro_fin);

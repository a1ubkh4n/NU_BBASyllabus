...
public class financial_acc_for_mar extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_financial_acc_for_mar);

        webA = (WebView) findViewById(R.id.webfinanAccMar);
        bar=(ProgressBar) findViewById(R.id.progressfinanAccMar);
        ...
        String myurl = "file:///android_asset/www/financial_acc_for_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.finanAccMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfinanAccMar);

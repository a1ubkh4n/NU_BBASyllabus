...
public class financial_analysis extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_financial_analysis);

        webA = (WebView) findViewById(R.id.webFinAna);
        bar=(ProgressBar) findViewById(R.id.progressFinAna);
        ...
        String myurl = "file:///android_asset/www/financial_analysis.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.fin_analy );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewFinAna);

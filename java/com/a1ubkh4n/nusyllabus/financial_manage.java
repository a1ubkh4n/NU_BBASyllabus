...
public class financial_manage extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webA = (WebView) findViewById(R.id.webFinMan);
        bar=(ProgressBar) findViewById(R.id.progressFinMan);
        ...
        String myurl = "file:///android_asset/www/financial_manage.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.finMan );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewFinMan);

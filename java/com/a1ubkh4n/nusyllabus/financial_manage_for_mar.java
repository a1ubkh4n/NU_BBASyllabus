...
public class financial_manage_for_mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_financial_manage_for_mar);

        webA = (WebView) findViewById(R.id.webfinanciMar);
        bar=(ProgressBar) findViewById(R.id.progressfinanciMar);
        ...
        String myurl = "file:///android_asset/www/financial_manage_for_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.financiMar);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfinanciMar);

...
public class funda_inves extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funda_inves);

        webA = (WebView) findViewById(R.id.webFunIn);
        bar=(ProgressBar) findViewById(R.id.progressFunIn);
        ...
        String myurl = "file:///android_asset/www/mar_entership_develop.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.funda_inve );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfunda);

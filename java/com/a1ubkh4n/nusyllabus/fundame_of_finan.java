...
public class fundame_of_finan extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fundame_of_finan);

        webA = (WebView) findViewById(R.id.webfunfinMar);
        bar=(ProgressBar) findViewById(R.id.progressfunfinMar);
        ...
        String myurl = "file:///android_asset/www/fundame_of_finan.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.funfinMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewfunfinMar);

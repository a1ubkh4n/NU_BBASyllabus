...
public class human_resour extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_human_resour);

        webA = (WebView) findViewById(R.id.webHuman);
        bar=(ProgressBar) findViewById(R.id.progressHuman);
        ...
        String myurl = "file:///android_asset/www/human_resour.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.huma_resou );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewhuman);

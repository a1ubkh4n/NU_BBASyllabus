...
public class innovation_and_newproduct extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_innovation_and_newproduct);

        webA = (WebView) findViewById(R.id.webInno);
        bar=(ProgressBar) findViewById(R.id.progressInno);
        ...
        String myurl = "file:///android_asset/www/mar_marketing_research.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.inno_newpro );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewInno);

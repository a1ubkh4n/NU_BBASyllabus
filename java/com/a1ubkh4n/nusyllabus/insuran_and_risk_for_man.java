...
public class insuran_and_risk_for_man extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insuran_and_risk_for_man);

        webA = (WebView) findViewById(R.id.webinsuMar);
        bar=(ProgressBar) findViewById(R.id.progressinsuMar);
        ...
        String myurl = "file:///android_asset/www/insuran_and_risk_for_man.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.insuMar);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewinsuMar);

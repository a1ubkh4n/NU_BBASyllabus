...
public class inter_acc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_acc);

        webA = (WebView) findViewById(R.id.webInteracc);
        bar=(ProgressBar) findViewById(R.id.progressInteracc);
        ...
        String myurl = "file:///android_asset/www/inter_acc.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.inter_acc );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewinter_acc);

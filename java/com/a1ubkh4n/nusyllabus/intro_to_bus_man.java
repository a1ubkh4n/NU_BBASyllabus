...
public class intro_to_bus_man extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_to_bus_man);

        webA = (WebView) findViewById(R.id.webintrobusMan);
        bar=(ProgressBar) findViewById(R.id.progressBarintrobusMan);
        ...
        String myurl = "file:///android_asset/www/intro_to_bus_man.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.introbusMan );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewintrobusMan);

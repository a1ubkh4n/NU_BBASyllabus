...
public class intro_to_bus_mar extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_to_bus_mar);

        webA = (WebView) findViewById(R.id.webintroBusmar);
        bar=(ProgressBar) findViewById(R.id.progressintroBusmar);
        ...
        String myurl = "file:///android_asset/www/intro_to_bus_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.introBusmar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewintroBusmar);

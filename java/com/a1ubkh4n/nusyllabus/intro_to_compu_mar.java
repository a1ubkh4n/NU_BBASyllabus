...
public class intro_to_compu_mar extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_to_compu_mar);

        webA = (WebView) findViewById(R.id.webintroComMar);
        bar=(ProgressBar) findViewById(R.id.progressBarintroComMar);
        ...
        String myurl = "file:///android_asset/www/intro_to_compu_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);


        Toolbar toolbar = (Toolbar) findViewById( R.id.introComMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewintroComMar);

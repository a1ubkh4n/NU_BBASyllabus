...
public class islamic_banking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_islamic_banking);

        webA = (WebView) findViewById(R.id.webislamicFan);
        bar=(ProgressBar) findViewById(R.id.progressislamicFan);
        ...
        String myurl = "file:///android_asset/www/islamic_banking.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.islamicFan);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewislamicFan);

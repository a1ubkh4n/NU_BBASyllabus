...
public class law_and_practices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law_and_practices);

        webA = (WebView) findViewById(R.id.weblawPracti);
        bar=(ProgressBar) findViewById(R.id.progresslawPracti);
        ...
        String myurl = "file:///android_asset/www/law_and_practices.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.lawPracti );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewlawPracti);

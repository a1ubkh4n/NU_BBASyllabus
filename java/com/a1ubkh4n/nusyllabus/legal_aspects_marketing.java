...
public class legal_aspects_marketing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legal_aspects_marketing);

        webA = (WebView) findViewById(R.id.weblegalaspectMar);
        bar=(ProgressBar) findViewById(R.id.progresslegalaspectMar);
        ...
        String myurl = "file:///android_asset/www/legal_aspects_marketing.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.legalaspectMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewlegalaspectMar);

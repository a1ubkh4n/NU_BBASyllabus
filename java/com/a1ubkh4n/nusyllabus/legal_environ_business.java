...
public class legal_environ_business extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legal_environ_business);

        webA = (WebView) findViewById(R.id.weblegalenMan);
        bar=(ProgressBar) findViewById(R.id.progresslegalenMan);
        ...
        String myurl = "file:///android_asset/www/legal_environ_business.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.legalenMan );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewlegalenMan);

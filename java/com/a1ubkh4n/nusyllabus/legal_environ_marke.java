...
public class legal_environ_marke extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legal_environ_marke);

        webA = (WebView) findViewById(R.id.webLegal);
        bar=(ProgressBar) findViewById(R.id.progressLegal);
        ...
        String myurl = "file:///android_asset/www/mar_sales_manage.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.legal_environ );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewLegal);

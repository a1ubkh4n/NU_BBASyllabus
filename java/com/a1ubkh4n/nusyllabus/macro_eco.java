...
public class macro_eco extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_macro_eco);

        webA = (WebView) findViewById(R.id.webMacro);
        bar=(ProgressBar) findViewById(R.id.progressMacro);
        ...
        String myurl = "file:///android_asset/www/macro_eco.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mac_eco );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmac_eco);

...
public class macro_eco_for_fin_acc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_macro_eco_for_fin_acc);

        webA = (WebView) findViewById(R.id.webmacroecoFinn);
        bar=(ProgressBar) findViewById(R.id.progressmacroecoFinn);
        ...
        String myurl = "file:///android_asset/www/macro_eco_for_fin_acc.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.macroecoFinn );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmacroecoFinn);

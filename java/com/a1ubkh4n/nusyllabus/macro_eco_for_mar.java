...
public class macro_eco_for_mar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_macro_eco_for_mar);

        webA = (WebView) findViewById(R.id.webmacrEcoMar);
        bar=(ProgressBar) findViewById(R.id.progressmacrEcoMar);
        ...
        String myurl = "file:///android_asset/www/macro_eco_for_mar.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.macrEcoMar );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmacrEcoMar);

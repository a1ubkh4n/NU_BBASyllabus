...
public class man_bangla_econo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_bangla_econo);

        webAb = (WebView) findViewById(R.id.webman_bangla_econo);
        bar=(ProgressBar) findViewById(R.id.progressBarman_bangla_econo);
        ...
        String myurl = "file:///android_asset/www/man_bangla_econo.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_bangla_econo);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_bangla_econo);

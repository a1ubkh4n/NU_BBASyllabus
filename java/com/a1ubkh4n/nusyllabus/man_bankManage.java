...
public class man_bankManage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_bank_manage);

        webAb = (WebView) findViewById(R.id.webbankManage);
        bar=(ProgressBar) findViewById(R.id.progressbankManage);
        ...
        String myurl = "file:///android_asset/www/man_bankmanage.html.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.bankManage);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewbankManage);

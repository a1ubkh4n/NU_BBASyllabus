...
public class man_company_law extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_company_law);

        webAb = (WebView) findViewById(R.id.webman_company_law);
        bar=(ProgressBar) findViewById(R.id.progressBarman_company_law);
        ...
        String myurl = "file:///android_asset/www/man_company_law.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_company_law);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_company_law);

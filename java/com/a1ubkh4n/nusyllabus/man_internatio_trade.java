...
public class man_internatio_trade extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_internatio_trade);

        webAb = (WebView) findViewById(R.id.webman_internatio_trade);
        bar=(ProgressBar) findViewById(R.id.progressBarman_internatio_trade);
        ...
        String myurl = "file:///android_asset/www/man_internatio_trade.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_internatio_trade );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_internatio_trade);

...
public class man_investment_manage extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_investment_manage);

        webAb = (WebView) findViewById(R.id.webman_investment_manage);
        ...
        String myurl = "file:///android_asset/www/man_investment_manage.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_investment_manage );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_investment_manage);

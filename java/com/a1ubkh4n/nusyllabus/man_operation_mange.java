...
public class man_operation_mange extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_operation_mange);

        webAb = (WebView) findViewById(R.id.webman_operation_mange);
        bar=(ProgressBar) findViewById(R.id.progressBarman_operation_mange);
        ...
        String myurl = "file:///android_asset/www/man_operation_mange.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_operation_mange);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_operation_mange);

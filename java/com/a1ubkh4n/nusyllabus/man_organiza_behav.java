...
public class man_organiza_behav extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_organiza_behav);

        webAb = (WebView) findViewById(R.id.webman_organiza_behav);
        bar=(ProgressBar) findViewById(R.id.progressBarman_organiza_behav);
        ...
        String myurl = "file:///android_asset/www/man_organiza_behav.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_organiza_behav);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_organiza_behav);

...
public class man_project_manage extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_project_manage);

        webAb = (WebView) findViewById(R.id.webman_project_manage);
        bar=(ProgressBar) findViewById(R.id.progressBarman_project_manage);
        ...
        String myurl = "file:///android_asset/www/man_project_manage.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.man_project_manage);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewman_project_manage);

...
public class manage_accoun extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_accoun);

        webA = (WebView) findViewById(R.id.webManage);
        bar=(ProgressBar) findViewById(R.id.progressManage);
        ...
        String myurl = "file:///android_asset/www/manage_accoun.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.manAcc );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewManAcc);

...
public class mar_adver_and_promo extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_adver_and_promo);

        webAb = (WebView) findViewById(R.id.webmar_adver_and_promo);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_adver_and_promo);
        ...
        String myurl = "file:///android_asset/www/mar_adver_and_promo.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_adver_and_promo );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_adver_and_promo);

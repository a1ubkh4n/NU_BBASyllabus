...
public class mar_bangla_econo extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_bangla_econo);

        webAb = (WebView) findViewById(R.id.webmar_bangla_econo);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_bangla_econo);
        ...
        String myurl = "file:///android_asset/www/mar_bangla_econo.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_bangla_econo);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_bangla_econo);

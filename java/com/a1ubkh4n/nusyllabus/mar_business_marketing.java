...
public class mar_business_marketing extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_business_marketing);

        webAb = (WebView) findViewById(R.id.webmar_business_marketing);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_business_marketing);
        ...
        String myurl = "file:///android_asset/www/mar_business_marketing.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_business_marketing );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_business_marketing);

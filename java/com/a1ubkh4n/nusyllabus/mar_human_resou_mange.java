...
public class mar_human_resou_mange extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_human_resou_mange);

        webAb = (WebView) findViewById(R.id.webmar_human_resou_mange);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_human_resou_mange);
        ...
        String myurl = "file:///android_asset/www/mar_human_resou_mange.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_human_resou_mange);
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_human_resou_mange);

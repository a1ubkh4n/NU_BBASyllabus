...
public class mar_interna_business extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_interna_business);

        webAb = (WebView) findViewById(R.id.webmar_interna_business);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_interna_business);
        ...
        String myurl = "file:///android_asset/www/mar_interna_business.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_interna_business );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_interna_business);

...
public class mar_organis_behaviou extends AppCompatActivity {
    WebView webAb;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mar_organis_behaviou);

        webAb = (WebView) findViewById(R.id.webmar_organis_behaviou);
        bar=(ProgressBar) findViewById(R.id.progressBarmar_organis_behaviou);
        ...
        String myurl = "file:///android_asset/www/mar_organis_behaviou.html";
        webAb.getSettings().setJavaScriptEnabled(true);
        webAb.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.mar_organis_behaviou );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmar_organis_behaviou);

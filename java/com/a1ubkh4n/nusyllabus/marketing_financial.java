...
public class marketing_financial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketing_financial);

        webA = (WebView) findViewById(R.id.webmarketingFin);
        bar=(ProgressBar) findViewById(R.id.progressmarketingFin);
        ...
        String myurl = "file:///android_asset/www/marketing_financial.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.marketingFin );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmarketingFin);

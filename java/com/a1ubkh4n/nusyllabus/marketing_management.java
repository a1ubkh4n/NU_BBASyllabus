...
public class marketing_management extends AppCompatActivity {
    WebView webA;
    ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webA = (WebView) findViewById(R.id.webMarMan);
        bar=(ProgressBar) findViewById(R.id.progressMarMan);
        ...
        String myurl = "file:///android_asset/www/marketing_management.html";
        webA.getSettings().setJavaScriptEnabled(true);
        webA.loadUrl(myurl);

        Toolbar toolbar = (Toolbar) findViewById( R.id.marMan );
        setSupportActionBar( toolbar );

        AdView adView = (AdView) findViewById(R.id.adViewmarMan);
